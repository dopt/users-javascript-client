...
export class Users {
     ...
     *
     * @example
     *     await doptApi.users.identifyUser({
     ...
     *
     * @example
     *     await doptApi.users.identifyUsers([{
     *             identifier: "identifier",
     *             properties: {}
     *         }])
     */
    public async identifyUsers(
        request: DoptApi.IdentifyBatchRequestBody,
        requestOptions?: Users.RequestOptions
        ...
        const _response = await core.fetcher({
            ...
            contentType: "application/json",
            body: await serializers.IdentifyBatchRequestBody.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
            maxRetries: requestOptions?.maxRetries,
        });
        if (_response.ok) {
